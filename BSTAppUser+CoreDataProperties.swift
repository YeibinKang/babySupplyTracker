//
//  BSTAppUser+CoreDataProperties.swift
//  BabySupplyTracker
//
...
extension BSTAppUser {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<BSTAppUser> {
        return NSFetchRequest<BSTAppUser>(entityName: "BSTAppUser")
    }
...
extension BSTAppUser : Identifiable {
